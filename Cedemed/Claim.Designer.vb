...
Partial Class Claim
    ...
    Private Sub InitializeComponent()
        ...
        Me.claimableBS = New System.Windows.Forms.BindingSource(Me.components)
        Me.ClaimableTableAdapter = New Cedemed.ReceiveDatasetTableAdapters.ClaimableTableAdapter()
        ...
        CType(Me.claimableBS, System.ComponentModel.ISupportInitialize).BeginInit()
        Me.SuspendLayout()
        '
        'TransdateLabel
        '
        ...
        'claimableBS
        '
        Me.claimableBS.DataMember = "Claimable"
        Me.claimableBS.DataSource = Me.ReceiveDataset
        '
        'ClaimableTableAdapter
        '
        Me.ClaimableTableAdapter.ClearBeforeFill = True
        '
        'Claim
        '
        ...
        CType(Me.claimableBS, System.ComponentModel.ISupportInitialize).EndInit()
    ...
    Friend WithEvents claimableBS As BindingSource
    Friend WithEvents ClaimableTableAdapter As ReceiveDatasetTableAdapters.ClaimableTableAdapter
End Class
